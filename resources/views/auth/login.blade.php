                ...
                <div class="flex items-center justify-between">
                    <label for="remember_me" class="flex items-center cursor-pointer">
                        <input id="remember_me" 
                               type="checkbox" 
                               name="remember"
                               class="w-4 h-4 text-secondary bg-surface border-outline-variant rounded focus:ring-secondary focus:ring-2 cursor-pointer">
                        <span class="ml-2 font-body text-body-md text-on-surface-variant">
                            Remember me
                        </span>
                    </label>
                    ...
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" 
                           class="font-body text-body-md text-secondary hover:text-primary transition-colors">
                            Forgot password?
                        </a>
                    @endif
                </div>
